 ...
 *   upper nibble = LCD data, lower nibble = control
 *
 * LCD runs in 4-bit mode — each byte sent as two nibbles
 * with Enable pulse (E=1 then E=0) for each.
 *
...
#define LCD_ADDR            0x27    // 7-bit I2C address (A0-A2 all HIGH)
