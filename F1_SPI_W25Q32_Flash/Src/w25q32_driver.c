/*
 * w25q32_driver.c — Winbond W25Q32 SPI NOR flash driver
 *
...
// change these 3 lines if you wire CS to a different pin
#define CS_PORT      GPIOA
#define CS_PIN_MASK  GPIO_ODR_ODR4
...
// not exact but the loop runs long enough at 8 MHz HSI or 72 MHz PLL
...
void W25Q_Init(void)
{
    // PA4 as GP push-pull 50 MHz output
    RCC->APB2ENR |= RCC_APB2ENR_IOPAEN;

    GPIOA->CRL &= ~(GPIO_CRL_CNF4 | GPIO_CRL_MODE4);
    GPIOA->CRL |=  GPIO_CRL_MODE4;     // MODE=11 (50 MHz), CNF=00 (GP PP)
...
void W25Q_Reset(void)
{
    ...
    crude_delay(100000);   // datasheet says ~30 us, give it plenty
}
